...
class otica {
    public static int prim(Grafo g, int custo) {
        ...
        int total = rend-(g.num_vertices()-1)*custo;
        return total;
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<ramos; i++) {
            ...
            g.insert_new_arc(noA, noB, rendimento);
            g.insert_new_arc(noB, noA, rendimento);
        }

        int n = prim(g, custo);
        if (n<0) System.out.println("impossivel");
        else System.out.println("rendimento otimo: " + n);
    }
}