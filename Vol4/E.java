...
class E {
    ...
    public static void dijkstra_capacidades(Grafo g, int origem, int destino, int compmax) {
        ...
        System.out.println(cap[destino]);
    }
    ...
    public static void main(String[] args) {
        ...
        while (noA!=-1) {
            ...
            if (larg>=largmin && comp>=compmin && alt>=altmin) {
                g.insert_new_arc(noA, noB, comp);
                g.insert_new_arc(noB, noA, comp);
            }

            noA = stdin.nextInt();
        }

        dijkstra_capacidades(g, origem, destino, compmax);
    }
}